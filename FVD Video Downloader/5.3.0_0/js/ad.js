(function(){
	...
	function AD(){
		...
		this.filePath = function(){
			var os = fvdSingleDownloader.Utils.getOS();
		...
		this.getRotationItem = function( callback ){
			...
			fvdSingleDownloader.Utils.rotateText( self.filePath(), function( line ){
		...
		this.incrementRotateCounter = function(){
			fvdSingleDownloader.Utils.incrementRotateCounter( self.filePath() );
		}
