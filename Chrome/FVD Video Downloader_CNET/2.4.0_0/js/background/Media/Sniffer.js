(function(){
    ...
    var MediaSniffer = function(){
        ...
        const VIDEO_EXTENSIONS = ["flv", "ram", "mpg", "mpeg", "avi", "rm", "wmv", "mov", "asf", "mp3", "rbs", "movie", "divx", "mp4", "ogg", "mpeg4", "m4v", "webm"];
		...
		// prepare for special sites
		function prepareMediaResultSpecials( data ){
...
//console.log(media);
			...
			result = prepareMediaResultSpecials(result);
