...
(function(){
	...
	FVD_SINGLE_YT_Button = function(  ){
		...
		this.BUTTON_FOLDER_TITLE = "Set Default Dowlnoad folder";
		...
		this.insert = function( item )	{	
			...
			//dump('FVD_SINGLE_YT_Button - insert\r\n');
			...
			if( !doc.getElementById(this.BUTTON_ID) )
			{
				...
				button.addEventListener("click", function(event){
								...
								if( media[location.spec] )
								{
									...
									self.buildMediaList( media, button, null, item );					
								}	
								
							}, false);
			
				var elemFlag = doc.getElementById('watch-flag');
		...
		// -------------------------------------------------------------------------------------------
		this.buildMediaList = function( media, button, buttonId, item )  {
			...
			{
				var m = media[k];	
				var f = fvd_single.check_shows_format( m.ext, location.spec );
				if (f == true) 
				{
					var li = doc.createElement("li");
					var imageUrl = "";
...
//			this.createSetLi( menu, 'AD', item );
		
		}
		
		// -------------------------------------------------------------------------------------------
		this.createSetLi = function( menu, type, item )  {
