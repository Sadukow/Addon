(function(){
	...
	// ======================  DAILYMOTION  ==============================================================
	function buttonDailyMotion( mainMedia ){
		...
		function createButtonElementDM( buttonId ){
			...
			var buttonImg = '<span style="margin-right:5px;"><img src="'+ADDON_IMAGE+'" align="left"></span>';
			...
			for( var k in media )
			{
				...
				(function( medToDownload, span ){
								span.addEventListener("click", function(){
									downloadMediaItem( medToDownload );
								}, true);
							})( m, span );
	...
	// ======================  YOUTUBE  ==============================================================
	function buttonYouTube( mainMedia, msg_ad ) {
		...
		function buildMediaList( media, button, msg_ad ){
			...
			if( msg_ad )
			{
				...
				span.innerHTML = "<img style='margin-left:-6px;margin-right: 1px;' src='" + EXT_IMAGES["AD"] + "' align='left'>"+ad.title;	
				li.appendChild( span );	
